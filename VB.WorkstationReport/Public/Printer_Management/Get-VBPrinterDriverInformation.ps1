# ============================================================
# FUNCTION : Get-VBPrinterDriverInformation
# VERSION  : 1.0.2
...
.EXAMPLE
    Get-VBPrinterDriverInformation

.EXAMPLE
    Get-VBPrinterDriverInformation -ComputerName SERVER01

.EXAMPLE
    'SRV01','SRV02' | Get-VBPrinterDriverInformation -Credential (Get-Credential)
