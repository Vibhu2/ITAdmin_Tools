...
@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'v1.1.0 -- 05-05-2026 -- DNS analysis: added Get-VBDNSTopTalkers, Get-VBDNSTopDomains (pipeline + Export-Csv ready), Resolve-VBDNSHostname (PTR + device-type classification). Rewrote Format-VBDNSTopTalkers and Format-VBDNSTopDomains as display-only consumers with rank column and showing-N-of-total header.
            v1.0.1 -- 02-05-2026 -- Fixed manifest ReleaseNotes syntax error.
