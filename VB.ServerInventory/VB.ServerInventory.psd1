@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'v1.1.0 -- 04-06-2026 -- New: Get-VBSmbSharePermission -- returns SMB share-level and NTFS top-level ACEs for non-administrative file shares as structured objects. New: Export-VBSmbSharePermissionReport -- writes Get-VBSmbSharePermission output to a grouped, human-readable text report file.
